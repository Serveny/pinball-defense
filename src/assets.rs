...
pub struct PinballDefenseGltfAssets {
    ...
    pub mg_tower_mounting: Handle<Mesh>,
    pub mg_tower_head: Handle<Mesh>,
    pub mg_tower_barrels: Handle<Mesh>,
    pub mg_tower_trim: Handle<Mesh>,
    pub mg_tower_dark_iron_material: Handle<StandardMaterial>,
    pub mg_tower_copper_material: Handle<StandardMaterial>,
    pub mg_tower_steel_material: Handle<StandardMaterial>,
    pub mg_tower_brass_material: Handle<StandardMaterial>,
    pub tesla_glass_tubes: Handle<Mesh>,
    pub tesla_brass_parts: Handle<Mesh>,
    pub tesla_copper_parts: Handle<Mesh>,
    pub tesla_gauge_face: Handle<Mesh>,
    pub tesla_dome: Handle<Mesh>,
    pub tesla_glass_material: Handle<StandardMaterial>,
    pub tesla_brass_material: Handle<StandardMaterial>,
    pub tesla_copper_material: Handle<StandardMaterial>,
    pub tesla_enamel_material: Handle<StandardMaterial>,

    // Microwave
    pub mw_boiler: Handle<Mesh>,
    pub mw_boiler_trim: Handle<Mesh>,
    pub mw_pipes: Handle<Mesh>,
    pub mw_gauges: Handle<Mesh>,
    pub mw_dish_assembly: Handle<Mesh>,
    pub mw_dish_rim: Handle<Mesh>,
    pub mw_emitter_core: Handle<Mesh>,
    pub mw_mount_iron: Handle<Mesh>,
    pub mw_mount_brass: Handle<Mesh>,
    pub mw_mount_copper: Handle<Mesh>,
    pub microwave_dark_iron_material: Handle<StandardMaterial>,
    pub microwave_brass_material: Handle<StandardMaterial>,
    pub microwave_copper_material: Handle<StandardMaterial>,
    pub microwave_ivory_material: Handle<StandardMaterial>,
    pub microwave_emitter_glow_material: Handle<StandardMaterial>,
